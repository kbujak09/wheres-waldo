  ...
  return (
    <>
      ...
      <div className='levels'>
        ...
        <Link to='/wheres-waldo'><div className='levelLink' id='level02'>Coming Soon</div></Link>
        <Link to='/wheres-waldo'><div className='levelLink' id='level03'>Coming Soon</div></Link>
      </div>
      <Footer />
    </>
  )
